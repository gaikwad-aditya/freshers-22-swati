...
-- SELECT FIRST_NAME,HIRE_DATE, JOB_ID from employees where JOB_ID = 'IT_PROG' OR JOB_ID = 'SA_MAN'
...
-- SELECT * from employees WHERE (COMMISSION_PCT = 0 AND (SALARY >= 5000 AND SALARY <= 1000) AND DEPARTMENT_ID = 30 );
...
-- SELECT * FROM locations ORDER BY COUNTRY_ID ASC;

---------------------------------------------------------------------------------------------------------------------------------------
-- Assignment 5

-- Display first name and last name after converting the first letter of each name to upper case and the rest to lower case.
-- UPDATE employees  SET FIRST_NAME=UPPER(LEFT(FIRST_NAME,1))+LOWER(SUBSTRING(FIRST_NAME,2,LEN(FIRST_NAME)));
-- UPDATE employees  SET LAST_NAME=UPPER(LEFT(LAST_NAME,1))+LOWER(SUBSTRING(LAST_NAME,2,LEN(LAST_NAME)));
...
-- SELECT FIRST_NAME, LAST_NAME FROM employees where LAST_NAME LIKE '__b%'
...
-- SELECT FIRST_NAME, LAST_NAME, ROUND(SALARY,0) as Emp_SALARY  from employees;
...
-- SELECT  FIRST_NAME,  DATEADD(MONTH,1, HIRE_DATE) as SALARY_MONTH FROM employees;

-- Display first name and experience of the employees.
-- SELECT FIRST_NAME , DATEDIFF(year, HIRE_DATE, SYSDATETIME()) as EXPERIENCE FROM  employees

-- Display first name of employees who joined in 2001.
-- SELECT * FROM employees WHERE HIRE_DATE BETWEEN '2001-01-01' AND '2001-12-31';
...
-- Display third highest salary of employees. Not working
-- select * from( select EMPLOYEE_ID, SALARY, dense_rank() over(order by SALARY desc)r from employees) ;
